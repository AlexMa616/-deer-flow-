...
This gateway provides custom endpoints for models, MCP configuration, skills, and artifacts.
        ...
        openapi_tags=[
            ...
            {
                "name": "system",
                "description": "System overview and optimization hints",
            },
            {
                "name": "semantic",
    ...
    app.middleware("http")(ops_middleware)
    ...
    # System API is mounted at /api/system
    ...
    async def health_check() -> dict:
        ...
        """
        return health.get_health_snapshot().model_dump()
