...
<retrieval_system>
When answering questions grounded in uploaded files or memory, call `semantic_search` to retrieve relevant excerpts.
Include citations from the tool results (filename + artifact_url) to support your answer.
</retrieval_system>
